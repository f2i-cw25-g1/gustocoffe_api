 ...
 */
final class Version20210611095055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation_salon (id INT AUTO_INCREMENT NOT NULL, salon_id INT NOT NULL, date_reservation DATE NOT NULL, heure_debut TIME NOT NULL, heure_fin TIME NOT NULL, prix DOUBLE PRECISION NOT NULL, date_commande DATETIME NOT NULL, INDEX IDX_B11724B04C91BDE4 (salon_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
